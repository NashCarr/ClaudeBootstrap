...
{
    public class DbClientFacilitySave : IDisposable
    {
        public void Dispose()
        {
            Dispose(true);
        ...
        public string SaveClientFacility(ref ClientFacilityView data, ref int placeId)
        {
            string msg;
            ...
            {
                msg = db.SaveFacilityData(p, ref placeId);
            }
