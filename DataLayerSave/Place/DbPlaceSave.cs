...
namespace DataLayerSave.Place
{
    ...
    {
        private ReturnBase AddUpdatePlace(ref DataLayerCommon.Places.Place data)
        {
            try
            {
        ...
        protected internal ReturnBase SaveFacility(ref DataLayerCommon.Places.Place data)
        {
        ...
        public ReturnBase SaveCustomer(ref DataLayerCommon.Places.Place data)
        {
            if (string.IsNullOrEmpty(data.Name))
            {
                SetEmptyStringMessage("Name");
        ...
        protected internal ReturnBase SaveOrganization(ref DataLayerCommon.Places.Place data)
        {
            if (string.IsNullOrEmpty(data.Name))
            {
                SetEmptyStringMessage("Name");
        ...
        {
            DataLayerCommon.Places.Place p = data.Place;
